...
const Features = () => {
  ...
  return (
    <div className="mx-auto max-w-7xl w-full mt-10 flex justify-center h-full py-10">
      <div className=' p-8 w-full grid grid-cols-[minmax(0,1fr)_minmax(0,1fr)] gap-8'>
        <div className='flex flex-col gap-4 items-start justify-center'>
          ...
          <div className='text-5xl font-medium font-cal'>Comes with a variety of AI voices in each language</div>
          <div className='max-w-xl text-muted-foreground text-xl'>Radian consist of different male and female voices with different accents , so you can pick best for your work</div>
