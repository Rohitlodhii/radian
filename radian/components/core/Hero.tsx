...
const Hero = () => {
  return (
    <div className='h-[75vh] flex w-full relative items-center justify-center px-10'>
        ...
        <div className='border-border rounded-xl bg-secondary shadow-sm px-4 text-sm py-1 max-w-fit flex gap-2 items-center'>with 🎉BuiltnBuild <ChevronRight className='h-4 w-4 -translate-y-px'/></div>
